...
//Public methods
  void				SetRecursiveSub(BOOL b) { m_bRecursiveSub = b; };
  ...
  static BOOL       IsFolder(const CString& sPath);
  static BOOL       IsDrive(const CString& sPath);
  static  BOOL      IsUNCServerName(const CString& sPath);
  static BOOL       IsCompressed(const CString& sPath);
  static BOOL       IsEncrypted(const CString& sPath);
...
//Methods
  ...
  virtual BOOL        DisplayShares(HTREEITEM hParent, const CString& sComputer);
  virtual HTREEITEM   DisplayNetworkComputer(HTREEITEM hParent, const CString& sComputer);
  ...
  void				  AddCamFile(const CString& sPath, HTREEITEM hParent, CString strFileExt);
  void				  AddRecursiveCamFile(const CString& sPath, HTREEITEM hParent, CString strFileExt);
#ifndef FILETREECTRL_NO_RESOURCES  
  ...
  virtual BOOL        EnumNetwork(NETRESOURCE* pParentNetResource, HTREEITEM hParentItem);
